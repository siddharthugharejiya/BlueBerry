        ...
        <Slider {...settings}>
          <div className="px-2">
            ...
            <div className="flex justify-center items-center">
              <div className="h-[200px] w-full  border flex justify-center items-center flex-col rounded-2xl bg-[rgb(225_252_242)] group">
          ...
          <div className="px-2">
            ...
            <div className="flex justify-center items-center">
              <div className="h-[200px] w-full border flex justify-center items-center flex-col rounded-2xl bg-[rgb(244_241_254)] group">
          ...
          <div className="px-2">
            ...
            <div className="flex justify-center items-center">
              <div className="h-[200px] w-full border flex justify-center items-center flex-col rounded-2xl bg-[rgb(251_249_228)] group">
